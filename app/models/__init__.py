...
from .resin_spinning_model import ResinSpinningProcessModel 
from .attachment_model import AttachmentModel # 导入附件模型
...
#     'ModuleModel',
#     'RolePermissionModel',
#     'ResinSpinningProcessModel',
#     'AttachmentModel' # 新增附件模型到 __all__
# ]
